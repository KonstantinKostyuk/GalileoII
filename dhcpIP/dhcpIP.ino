/*
Galileo Ethernet connection example. Use DHCP for configure Ethernet connection
2014 Nov 01 Konstantin Kostyuk

Galileo specific - not need SPI library. Very othen incorrect processing DHCP.  
